  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-2">
      <input
        ...
        required
        className="w-full rounded-xl px-4 py-2.5 text-sm border border-gray-200 text-[#1A1A1A] placeholder-gray-400 focus:border-[#C8A96A] outline-none transition-colors"
      />
      {status === 'error' && (
