...
export const metadata: Metadata = {
  title: 'Terms of Service | Mela',
  description: 'Terms of Service for Mela — the South Asian wedding vendor directory for the Greater Toronto Area.',
}
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              By accessing or using Mela ("we", "our", "us") at melaa.ca, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our platform.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">4. Vendor Listings</h2>
            <p className="text-gray-600 leading-relaxed">
              Vendors are responsible for the accuracy of their listing information. Mela reserves the right to remove or modify any listing that violates these terms, contains inaccurate information, or is otherwise inappropriate. We do not guarantee leads, inquiries, or bookings to any vendor.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              By submitting content (photos, descriptions, contact information) to Mela, you grant us a non-exclusive, royalty-free licence to display that content on our platform and in our marketing materials. You represent that you own or have rights to all content you submit.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              You may not use Mela to post false or misleading information, spam other users, scrape or harvest data from our platform, interfere with our services, or engage in any unlawful activity.
            </p>
          </section>
