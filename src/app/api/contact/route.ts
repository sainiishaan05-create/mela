      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;">
          ...
          <table style="width:100%;border-collapse:collapse;font-size:14px;">
            <tr><td style="padding:8px 0;color:#999;width:80px;">Name</td><td style="padding:8px 0;color:#333;font-weight:600;">${name}</td></tr>
            <tr><td style="padding:8px 0;color:#999;">Email</td><td style="padding:8px 0;"><a href="mailto:${email}" style="color:#C8A96A;">${email}</a></td></tr>
            <tr><td style="padding:8px 0;color:#999;">Subject</td><td style="padding:8px 0;color:#333;">${subject}</td></tr>
          </table>
          ...
          <p style="color:#ccc;font-size:11px;margin-top:24px;">Reply directly to this email to respond to ${name}.</p>
        </div>
      `,
    })
