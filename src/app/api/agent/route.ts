    ...
    for (const vendor of atRisk ?? []) {
      await resend.emails.send({
        ...
        html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          ...
          <a href="${SITE}/dashboard" style="background:#E8760A;color:white;padding:10px 20px;border-radius:20px;text-decoration:none;display:inline-block;margin-top:12px">Dashboard →</a>
        </div>`,
      })
  ...
  if (day === 1 && hour === 7 && ADMIN_EMAIL) {
    ...
    if (gaps.length > 0) {
      ...
      await resend.emails.send({
        ...
        html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          <h2 style="color:#E8760A">Supply/Demand Gaps This Week</h2>
          ...
          <a href="${SITE}/admin/outreach" style="background:#E8760A;color:white;padding:10px 20px;border-radius:20px;text-decoration:none;display:inline-block;margin-top:16px">Start Outreach →</a>
        </div>`,
      })
    ...
    await resend.emails.send({
      ...
      html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto">
        ...
        <table style="width:100%;border-collapse:collapse;margin:16px 0">
          ...
          <td style="padding:10px;background:#fafaf7;border-radius:8px;text-align:center"><p style="margin:0;font-size:11px;color:#999;text-transform:uppercase">New This Week</p><p style="margin:4px 0 0;font-size:28px;font-weight:bold;color:#E8760A">${newVendors}</p></td>
          <td style="width:8px"></td>
  ...
  if ((day === 2 || day === 4) && hour === 10) {
    ...
    for (const lead of ghostedLeads ?? []) {
      ...
      await resend.emails.send({
        ...
        html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          <h2 style="color:#E8760A">We noticed you haven't heard back yet</h2>
          ...
          <a href="${SITE}/vendors?category=${catSlug}${citySlug ? `&city=${citySlug}` : ''}" style="background:#E8760A;color:white;padding:12px 24px;border-radius:20px;text-decoration:none;display:inline-block;margin-top:12px">Find Other Vendors →</a>
