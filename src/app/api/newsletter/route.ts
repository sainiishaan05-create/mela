...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  <tr><td style="background:#111111;border-radius:20px 20px 0 0;padding:40px 48px 32px;text-align:center;">
    <h1 style="margin:0;font-size:32px;font-weight:700;color:#C8A96A;font-family:Georgia,serif;">Melaa</h1>
  ...
  <tr><td style="background:#fff;padding:40px 48px;">
    ...
    <div style="background:#FFF8F2;border-radius:12px;border-left:3px solid #C8A96A;padding:14px 16px;margin-bottom:12px;">
    ...
    <div style="text-align:center;margin-bottom:32px;">
      <a href="https://melaa.ca/vendors" style="display:inline-block;background:#C8A96A;color:#fff;font-size:15px;font-weight:700;padding:14px 36px;border-radius:50px;text-decoration:none;">Browse 2,700+ Vendors &rarr;</a>
    </div>
    <p style="margin:0;color:#aaa;font-size:12px;text-align:center;">You subscribed at melaa.ca &middot; <a href="https://melaa.ca" style="color:#C8A96A;">Visit site</a></p>
  </td></tr>
  <tr><td style="background:#F5F5F0;border-radius:0 0 20px 20px;padding:20px 48px;text-align:center;">
    <p style="margin:0;color:#bbb;font-size:12px;">&copy; 2026 Melaa &middot; <a href="https://melaa.ca" style="color:#C8A96A;text-decoration:none;">melaa.ca</a></p>
  </td></tr>
</table>
</td></tr>
</table>
