  ...
  try {
    const ai = await anthropic.messages.create({
      ...
      messages: [
        {
          role: 'user',
          content: `Write a short ${platform} outreach message to ${businessName}, a South Asian wedding ${category} in ${city}, inviting them to list on Mela (mela.ca) for free. Warm, direct, South Asian community tone. Under 80 words. No hashtags.`,
        },
      ],
    })
